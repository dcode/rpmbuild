...
Patch0:         https://src.fedoraproject.org/cgit/rpms/python-kombu.git/plain/qpid-transport-works-with-celery-4.patch?h=f26#/qpid-transport-works-with-celery-4.patch
