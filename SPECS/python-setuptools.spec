...
Source1:        https://src.fedoraproject.org/cgit/rpms/python-setuptools.git/plain/psfl.txt?h=f23#/psfl.txt
Source2:        https://src.fedoraproject.org/cgit/rpms/python-setuptools.git/plain/zpl.txt?h=f23#/zpl.txt
