...
Patch0:         https://src.fedoraproject.org/cgit/rpms/python-nose.git/plain/python-nose-coverage4.patch
# Fix python 3.5 compat
# https://github.com/nose-devs/nose/pull/983
Patch1:         https://src.fedoraproject.org/cgit/rpms/python-nose.git/plain/python-nose-py35.patch
# Fix UnicodeDecodeError with captured output
# https://github.com/nose-devs/nose/pull/988
Patch2:         https://src.fedoraproject.org/cgit/rpms/python-nose.git/plain/python-nose-unicode.patch
# Allow docutils to read utf-8 source
Patch3:         https://src.fedoraproject.org/cgit/rpms/python-nose.git/plain/python-nose-readunicode.patch
# Fix Python 3.6 compatibility
# Python now returns ModuleNotFoundError instead of the previous ImportError
# https://github.com/nose-devs/nose/pull/1029
Patch4:         https://src.fedoraproject.org/cgit/rpms/python-nose.git/plain/python-nose-py36.patch
